...
typedef struct {
    ...
    uint8_t x2001_threshold;
    uint8_t x2002_limits_sub0;
    uint16_t x2002_limits[OD_CNT_ARR_2002];
    uint8_t x2003_joy_mode;
} OD_PERSIST_COMM_t;
...
typedef struct {
    ...
    uint8_t x2000_joystick_sub0;
    int8_t x2000_joystick[OD_CNT_ARR_2000];
} OD_RAM_t;
...
#define OD_ENTRY_H2000_joystick &OD->list[33]
#define OD_ENTRY_H2001_threshold &OD->list[34]
#define OD_ENTRY_H2002_limits &OD->list[35]
#define OD_ENTRY_H2003_joy_mode &OD->list[36]
